...
def main():
    ...
    if page == 'Home':
        ...
        image = Image.open("C:/Users/navee/QGIS_web_app/1.jpg")
       ...
       # Plot Creation Process Section
        ...
        image = Image.open("C:/Users/navee/QGIS_web_app/UK_raw.png")

        st.image(image,caption="Plot generated by Aerialod (UK)", use_column_width=True)
        
        image = Image.open("C:/Users/navee/QGIS_web_app/2.jpg")

        st.image(image,caption="Plot generated by Aerialod", use_column_width=True)
        
        image = Image.open("C:/Users/navee/QGIS_web_app/india_raw.png")
